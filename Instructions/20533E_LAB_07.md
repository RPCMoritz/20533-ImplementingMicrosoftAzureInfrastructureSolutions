...
1. Download and configure the credentials to access the AKS cluster, by running the **az aks get-credentials** command with the following parameters from the bash prompt in the Cloud shell pane:
